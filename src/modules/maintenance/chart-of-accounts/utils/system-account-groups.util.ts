...
export const SystemAccountGroupTags = {
  ...
  discountManagementSalesParent: 'Discount Maintenance Sales Parent',
  purchaseDiscount: 'Purchase Discount',
  discountManagementPurchaseParent: 'Discount Maintenance Purchase Parent',
  ...
  taxMaintenanceTaxesPayablesGroup: 'Tax Payables Group',
  taxMaintenanceInputTaxAccount: 'Tax Input Tax Account',
  taxMaintenanceOutputVatAccount: 'Tax Output VAT Account',
  taxMaintenanceDeferredVatAccount: 'Tax Deferred VAT Account',
  taxMaintenanceExpandedWithholdingTaxAccount: 'Tax Expanded Withholding Tax Account',
  taxMaintenanceCreditableWithholdingTaxAccount: 'Tax Creditable Withholding Tax Account',
  taxMaintenanceWithholdingVatableTaxAccount: 'Tax Withholding Vatable Tax Account',
  taxMaintenanceFinalWithholdingTaxAccount: 'Tax Final Withholding Tax Account',
} as const;
