...
import type { DisbursementTypePayload, GeneratedDefaultAccount } from '../types/disbursement-type.type';

export function mapDisbursementType(template: DisbursementTypePayload, userNames: Map<number, string> = new Map()) {
  return {
