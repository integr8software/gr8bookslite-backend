...
import type { CollectionTypePayload, GeneratedDefaultAccount } from '../types/collection-type.type';

export function mapCollectionType(template: CollectionTypePayload, userNames: Map<number, string> = new Map()) {
  return {
