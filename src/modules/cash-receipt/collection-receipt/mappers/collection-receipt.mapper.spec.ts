...
describe('mapCollectionReceipt', () => {
  it('maps payment details, monetary values, and journal snapshots for the API', () => {
    const receipt = {
      ...
      receiptNo: 'CR-2026-0006',
      referenceNo: 'REF-001',
      remarks: null,
      status: CollectionReceiptStatus.DRAFT,
      transactionNo: 'CR-2026-0006',
    ...
    } as unknown as CollectionReceiptWithDetails;

    const mapped = mapCollectionReceipt(
      receipt,
      new Map([
        [7, 'Creator User'],
        [8, 'Updater User'],
