...
import { ProvisionalReceiptJournalEntryDto } from './provisional-receipt-journal-entry.dto';
...
export class CreateProvisionalReceiptDto {
  ...
  @ApiPropertyOptional({ example: 'PVR-000001', maxLength: 80, nullable: true })
  @IsOptional()
  @IsString()
  @MaxLength(80)
  ...
  @ApiPropertyOptional({ example: 'PVR-REF-0001', maxLength: 120, nullable: true })
  @IsOptional()
  @IsString()
  @MaxLength(120)
  ...
  @ApiProperty({ type: [ProvisionalReceiptDetailDto], minItems: 1 })
  @IsArray()
  @ArrayMinSize(1)
  @ValidateNested({ each: true })
  @Type(() => ProvisionalReceiptDetailDto)
  details!: ProvisionalReceiptDetailDto[];

  @ApiProperty({ type: [ProvisionalReceiptJournalEntryDto], minItems: 2 })
  @IsArray()
  @ArrayMinSize(2)
  @ValidateNested({ each: true })
  @Type(() => ProvisionalReceiptJournalEntryDto)
