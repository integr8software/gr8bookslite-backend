import { amountsMatch, getAcknowledgementReceiptDetailTotals, getJournalEntryTotals, roundCurrency } from './acknowledgement-receipt-totals.util';

describe('acknowledgement receipt total utilities', () => {
  ...
  it('totals detail rows using the persisted receipt amount fields', () => {
    expect(
      getAcknowledgementReceiptDetailTotals([
