...
import { mapAcknowledgementReceipt } from './acknowledgement-receipt.mapper';
import type { AcknowledgementReceiptWithDetails } from '../types/acknowledgement-receipt-with-details.type';

describe('mapAcknowledgementReceipt', () => {
  it('maps payment details, monetary values, and journal snapshots for the API', () => {
    ...
    } as unknown as AcknowledgementReceiptWithDetails;

    const mapped = mapAcknowledgementReceipt(
      receipt,
      new Map([
        [7, 'Creator User'],
        [8, 'Updater User'],
