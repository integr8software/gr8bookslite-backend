...
import { BillingInvoiceDetailDto } from './billing-invoice-detail.dto';
import { BillingInvoiceJournalEntryDto } from './billing-invoice-journal-entry.dto';
...
export class CreateBillingInvoiceDto {
  ...
  @Type(() => BillingInvoiceDetailDto)
  details!: BillingInvoiceDetailDto[];

  @IsArray()
  @ArrayMinSize(2)
  @ValidateNested({ each: true })
  @Type(() => BillingInvoiceJournalEntryDto)
