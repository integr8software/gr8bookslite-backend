...
import { ServiceInvoiceDetailDto } from './service-invoice-detail.dto';
import { ServiceInvoiceJournalEntryDto } from './service-invoice-journal-entry.dto';
...
export class CreateServiceInvoiceDto {
  ...
  @Type(() => ServiceInvoiceDetailDto)
  details!: ServiceInvoiceDetailDto[];

  @IsArray()
  @ArrayMinSize(2)
  @ValidateNested({ each: true })
  @Type(() => ServiceInvoiceJournalEntryDto)
