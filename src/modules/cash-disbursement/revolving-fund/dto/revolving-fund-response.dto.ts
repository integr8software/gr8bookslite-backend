...
import { RevolvingFundDetailDto } from './revolving-fund-detail.dto';

export class RevolvingFundResponseDto {
  ...
  @ApiProperty({ description: 'Transaction Number', example: 'RF-2026-000001' })
  ...
  @ApiProperty({ description: 'Party Name Snapshot', example: 'Jane Smith' })
  partyNameSnapshot: string;

  @ApiPropertyOptional({ description: 'Party Code alias', example: 'EMP-001' })
  partyCode?: string;

  @ApiPropertyOptional({ description: 'Party Name alias', example: 'Jane Smith' })
  partyName?: string;
  ...
  @ApiProperty({ description: 'Account Code Snapshot', example: '1010102000' })
  ...
  @ApiPropertyOptional({ description: 'Default Account Code alias', example: '1010102000' })
  accountCode?: string;

  @ApiPropertyOptional({ description: 'Default Account Title alias', example: 'Revolving Fund' })
  ...
  @ApiProperty({ description: 'Amount', example: 20000.0 })
  amount: number;

  @ApiPropertyOptional({ description: 'Remarks', example: 'Revolving fund setup' })
  remarks?: string | null;
...
export class RevolvingFundPaginationMetaDto {
