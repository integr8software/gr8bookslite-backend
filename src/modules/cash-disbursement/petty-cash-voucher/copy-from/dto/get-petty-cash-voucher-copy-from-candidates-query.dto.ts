...
export class GetPettyCashVoucherCopyFromCandidatesQueryDto {
  @ApiPropertyOptional({ description: 'Search term across transaction number, party, or remarks', example: 'PCV-2026' })
  @IsOptional()
  @IsString()
  @MaxLength(120)
  search?: string;
