...
export class PettyCashReplenishmentCopyFromCandidateDetailDto {
  @ApiProperty({ description: 'Petty Cash Replenishment detail line ID', example: '1' })
  id: string;

  @ApiProperty({ description: 'Source line number', example: 1 })
  lineNumber: number;

  @ApiPropertyOptional({ description: 'Petty cash source date', example: '2026-09-07' })
  pettyCashDate?: string | null;

  @ApiPropertyOptional({ description: 'Petty cash source number', example: 'PCV:PCV-2026-000001' })
...
export class PettyCashReplenishmentCopyFromCandidateDto {
  @ApiProperty({ description: 'Petty Cash Replenishment ID', example: '1' })
  id: string;

  @ApiProperty({ description: 'Petty Cash Replenishment transaction number', example: 'PCR-2026-000001' })
  ...
  @ApiProperty({ description: 'Default account code', example: '1010101000' })
  ...
  @ApiProperty({ description: 'PCR detail lines to copy into the target voucher', type: () => [PettyCashReplenishmentCopyFromCandidateDetailDto] })
  details: PettyCashReplenishmentCopyFromCandidateDetailDto[];

  @ApiProperty({ description: 'Source module display name', example: 'Petty Cash Replenishment' })
  source: string;

  @ApiProperty({ description: 'Source transaction number', example: 'PCR-2026-000001' })
  sourceNo: string;
}

export class PettyCashReplenishmentCopyFromCandidatesResponseDto {
  @ApiProperty({ description: 'Available PCR records', type: () => [PettyCashReplenishmentCopyFromCandidateDto] })
