...
export class GetPettyCashReplenishmentListQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Search term', example: 'PCR-2026' })
  @IsOptional()
  @IsString()
  search?: string;

  @ApiPropertyOptional({ description: 'Status filter', enum: PettyCashReplenishmentStatus })
  @IsOptional()
