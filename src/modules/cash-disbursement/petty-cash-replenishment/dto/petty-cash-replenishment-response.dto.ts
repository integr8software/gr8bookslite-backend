...
export class PettyCashReplenishmentResponseDto {
  ...
  @ApiProperty({ description: 'Transaction Number', example: 'PCR-2026-000001' })
...
export class PettyCashReplenishmentPaginationMetaDto {
