import { amountsMatch, getCashVoucherDetailTotals, getJournalEntryTotals, roundCurrency } from './cash-voucher-totals.util';

describe('cash voucher total utilities', () => {
