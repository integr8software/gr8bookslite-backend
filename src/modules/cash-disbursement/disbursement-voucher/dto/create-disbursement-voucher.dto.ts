...
import { DisbursementVoucherStatus } from '@prisma/client';
import { Type } from 'class-transformer';
import { IsArray, IsDateString, IsEnum, IsInt, IsNumber, IsObject, IsOptional, IsString, MaxLength, Min, ValidateNested } from 'class-validator';
import { DisbursementVoucherDetailDto } from './disbursement-voucher-detail.dto';
import { JournalEntryDto } from './journal-entry.dto';

export class CreateDisbursementVoucherDto {
  ...
  @ApiPropertyOptional({ description: 'Transaction / Voucher Sequence No', example: 'DV-2026-000001' })
  @IsString()
  @IsOptional()
  @MaxLength(80)
  transactionNo?: string | null;

  @ApiPropertyOptional({ description: 'Voucher No (alias for transactionNo)', example: 'DV-2026-000001' })
  @IsString()
  @IsOptional()
  @MaxLength(80)
  ...
  @ApiPropertyOptional({ description: 'Payment Method', example: 'Check' })
  @IsString()
  @IsOptional()
  @MaxLength(50)
  ...
  @ApiPropertyOptional({ description: 'Voucher attachment metadata', type: 'array', items: { type: 'object' } })
  @IsArray()
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Voucher Status', enum: DisbursementVoucherStatus, default: DisbursementVoucherStatus.DRAFT })
  @IsEnum(DisbursementVoucherStatus)
  @IsOptional()
