...
export class DisbursementVoucherDetailResponseDto {
...
export class DisbursementVoucherRecordResponseDto {
  @ApiProperty({ description: 'Disbursement Voucher ID', example: '1' })
  id: string;

  @ApiPropertyOptional({ description: 'Branch Unit ID', example: 1 })
  branchUnitId?: number | null;

  @ApiProperty({ description: 'Voucher Sequence Number', example: 'DV-2026-000001' })
  voucherNo: string;
  ...
  @ApiProperty({ description: 'Payment Method', example: 'Check' })
...
export class DisbursementVoucherStatisticsDto {
...
export class DisbursementVoucherPaginationMetaDto {
