...
export class PettyCashFundCopyFromCandidateDetailDto {
  @ApiProperty({ description: 'Petty Cash Fund detail line ID', example: '1' })
  id: string;
...
export class PettyCashFundCopyFromCandidateDto {
  @ApiProperty({ description: 'Petty Cash Fund ID', example: '1' })
  id: string;

  @ApiProperty({ description: 'Petty Cash Fund transaction number', example: 'PCF-2026-000001' })
  ...
  @ApiProperty({ description: 'PCF detail lines to copy into Petty Cash Replenishment', type: () => [PettyCashFundCopyFromCandidateDetailDto] })
  details: PettyCashFundCopyFromCandidateDetailDto[];

  @ApiProperty({ description: 'Source module display name', example: 'Petty Cash Fund' })
  source: string;

  @ApiProperty({ description: 'Source transaction number', example: 'PCF-2026-000001' })
  sourceNo: string;
}

export class PettyCashFundCopyFromCandidatesResponseDto {
  @ApiProperty({ description: 'Available PCF records', type: () => [PettyCashFundCopyFromCandidateDto] })
