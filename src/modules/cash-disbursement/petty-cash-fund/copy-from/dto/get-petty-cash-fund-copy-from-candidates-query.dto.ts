...
export class GetPettyCashFundCopyFromCandidatesQueryDto {
  @ApiPropertyOptional({ description: 'Search term across transaction number, party, or remarks', example: 'PCF-2026' })
  @IsOptional()
  @IsString()
  @MaxLength(120)
  search?: string;
