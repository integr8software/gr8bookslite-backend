...
export class GetPettyCashFundListQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Search term', example: 'PCF-2026' })
  @IsOptional()
  @IsString()
  search?: string;

  @ApiPropertyOptional({ description: 'Status filter', enum: PettyCashFundStatus })
  @IsOptional()
