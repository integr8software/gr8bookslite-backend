...
export class RevolvingFundReplenishmentResponseDto {
  ...
  @ApiProperty({ description: 'Transaction Number', example: 'RFR-2026-000001' })
  ...
  @ApiProperty({ description: 'Amount', example: 15000.0 })
  amount: number;
...
export class RevolvingFundReplenishmentPaginationMetaDto {
