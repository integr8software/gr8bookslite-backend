...
export class GetRevolvingFundReplenishmentListQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Search term', example: 'RFR-2026' })
  @IsOptional()
  @IsString()
  search?: string;

  @ApiPropertyOptional({ description: 'Status filter', enum: RevolvingFundReplenishmentStatus })
  @IsOptional()
