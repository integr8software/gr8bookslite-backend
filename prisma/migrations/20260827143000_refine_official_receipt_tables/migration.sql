ALTER TABLE "official_receipts" DROP CONSTRAINT IF EXISTS "official_receipts_term_id_fkey";
...
ALTER TABLE "official_receipts"
  ADD CONSTRAINT "official_receipts_payment_id_fkey"
  FOREIGN KEY ("payment_id") REFERENCES "payment_types"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "official_receipt_details"
...
UPDATE "official_receipt_details"
SET
  "cwt_code" = "ewt_type",
  "total_received" = GREATEST("gross_amount" - "ewt_amount", 0);
