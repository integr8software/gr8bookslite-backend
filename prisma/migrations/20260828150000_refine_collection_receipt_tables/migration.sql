...
ALTER TABLE "collection_receipts" DROP CONSTRAINT IF EXISTS "collection_receipts_term_id_fkey";
...
CREATE INDEX "collection_receipts_payment_id_idx" ON "collection_receipts"("payment_id");

ALTER TABLE "collection_receipts"
  ADD CONSTRAINT "collection_receipts_payment_id_fkey"
  FOREIGN KEY ("payment_id") REFERENCES "payment_types"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "collection_receipt_details"
...
UPDATE "collection_receipt_details" AS detail
SET
...
WHERE receipt."id" = detail."collection_receipt_id";
