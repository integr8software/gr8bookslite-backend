...
ALTER TABLE "provisional_receipts" DROP CONSTRAINT IF EXISTS "provisional_receipts_term_id_fkey";

ALTER TABLE "provisional_receipts"
...
CREATE INDEX "provisional_receipts_payment_id_idx" ON "provisional_receipts"("payment_id");

ALTER TABLE "provisional_receipts"
  ADD CONSTRAINT "provisional_receipts_payment_id_fkey"
  FOREIGN KEY ("payment_id") REFERENCES "payment_types"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "provisional_receipt_details"
...
UPDATE "provisional_receipt_details" AS detail
SET
...
FROM "provisional_receipts" AS receipt
WHERE receipt."id" = detail."provisional_receipt_id";
